...
const entityTemplate = {
  ...
  description: 'Generates a JPA @Entity class per entity, with @Id, @Column, @ManyToOne, and @Enumerated annotations.',
  version: '1.0.0',
  folder: 'SpringBoot',
  cells: [
    {
...
const dtoTemplate = {
  ...
  description: 'Generates a Java record DTO per entity. Entity references are flattened to their FK id.',
  version: '1.0.0',
  folder: 'SpringBoot',
  cells: [
    {
...
`,
    },
    {
      ...
      type: 'output',
      content: '',
      outputFilename: 'src/main/java/com/example/blog/repository/{{pascalCase name}}Repository.java',
    },
  ],
}
...
const sqlTemplate = {
  ...
  description: 'Generates a single Flyway V1__init.sql migration with CREATE TABLE statements for every entity, using Postgres-native types.',
  version: '1.0.0',
  folder: 'SpringBoot',
  cells: [
    {
...
const pomTemplate = {
  ...
  description: 'Generates a Maven pom.xml for Spring Boot 4 with JPA, Postgres, Flyway, and Web starters.',
  version: '1.0.0',
  folder: 'SpringBoot',
  cells: [
    {
