...
1. Go to the [Security tab](https://github.com/xomda/xomda-js/security) of this repository.
2. Click **Report a vulnerability** and fill in the form.

We will keep you informed of progress towards a fix and coordinate a disclosure date once a patch is ready.
