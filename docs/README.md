...
- [Refactoring](./REFACTORING.md) — active refactoring plan and status.
- [Roadmap](./TODO.md) — open tasks and forward-looking work.
- [.brainstorm/](./.brainstorm/) — non-authoritative founder notes and design brainstorms.
