...
toolchain and code-quality rules see [Development](./docs/development.md).
...
1. **Branch.** Create a feature branch from `main`:
   ...
   ```
2. **Make your changes** following the conventions in [Development](./docs/development.md) and the detailed coding
...
5. **Open a pull request** describing the _why_ of the change, not just the _what_. Link any related issues.
...
Add tests when adding functionality. See [Development → Tests](./docs/development.md#tests) for placement and naming.
...
The dependency graph is documented in [Architecture](./docs/architecture.md). Do not introduce cycles.

## Documentation changes

If your change alters user-facing behaviour or the data model, update the relevant document in `docs/`:

- API surface → [api.md](./docs/api.md)
- Data model schema → [data-model.md](./docs/data-model.md)
- Template language → [templates.md](./docs/templates.md)
- Tooling, scripts, env → [development.md](./docs/development.md)
...
- [Development](./docs/development.md) — toolchain, scripts, environment, troubleshooting.
- [Architecture](./docs/architecture.md) — package layers and dependency direction.
