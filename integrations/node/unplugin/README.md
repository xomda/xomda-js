...
This package is a thin wrapper. The actual generation logic lives in the published
[`xomda`](../../../packages/xomda) package; internally it composes:
...
A separate Vite plugin exported from `unplugin-xomda/styles`. In dev mode it replaces the bundled
