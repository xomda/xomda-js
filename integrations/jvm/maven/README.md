...
[`demo/springboot-blog`](../../../demo/springboot-blog) is a Spring Boot 4 project that consumes
this plugin. Its [`pom.xml`](../../../demo/springboot-blog/pom.xml) wires the plugin in and uses
the generated Java sources alongside hand-written code.
See also [`demo/quarkus-todos`](../../../demo/quarkus-todos) for a Quarkus 3 / Panache equivalent.
