...
public class OutputProcessor implements CellProcessor {
    ...
    private static Map<String, Object> buildFlatContext(CellContext ctx) {
        ...
        if (ctx.getScopeContext() != null) flat.putAll(ctx.getScopeContext());
