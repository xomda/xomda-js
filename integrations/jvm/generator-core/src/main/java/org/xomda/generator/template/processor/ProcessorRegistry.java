...
public class ProcessorRegistry {
    ...
    public ProcessorRegistry(Context graalCtx, Handlebars handlebars) {
        ...
        register(new LoopProcessor(CellType.LOOP));
        register(new LoopProcessor(CellType.LOOP_LOGIC));
    }
    ...
    public CellProcessor get(CellType type) {
        ...
        if (p == null)
            throw new IllegalArgumentException("No processor for cell type: " + type);
        return p;
    }
}
