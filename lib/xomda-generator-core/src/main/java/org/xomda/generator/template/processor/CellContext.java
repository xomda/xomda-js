...
public class CellContext {
    ...
    public Map<String, Object> getModelMap() { return modelMap; }
    public Map<String, Object> getScopeContext() { return scopeContext; }
    public String getTemplateUuid() { return templateUuid; }
    public Map<String, Object> getVariables() { return variables; }
    public List<OutputBuffer> getCellBuffers() { return cellBuffers; }
    public List<FileOutput> getFiles() { return files; }
    public OutputBuffer get$out() { return $out; }
