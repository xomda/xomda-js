...
import type { ComponentPublicInstance, PropType, SlotsType, VNode } from 'vue'
...
import type { Attribute, EntityData, EnumData, Layout, LayoutEntry, PackageData } from '../../types'
