...
import { findDropTarget, snap, useCanvasDrag } from '../../composables'
import {
  type Attribute,
  type EntityData,
  type EnumData,
...
export const Package = defineComponent({
  ...
  setup(props, { emit }) {
    ...
    function onHeaderPointerMove(e: PointerEvent) {
      ...
      // Cross-package drop-target hit-testing — only when this nested
      // Package's enclosing parent has a fixed size (so it didn't grow).
      if (props.parentPackageId && props.parentSizeFixed && packageEl.value) {
