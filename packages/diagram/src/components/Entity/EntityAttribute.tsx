      ...
      return (
        ...
        >
          <span class={styles.badges}>
            {inherited && <span class={[styles.badge, styles['badge--inh']]}>INH</span>}
            {!inherited && attr.primaryKey && (
              <span class={[styles.badge, styles['badge--pk']]}>PK</span>
            )}
            {!inherited && attr.unique && !attr.primaryKey && (
              <span class={[styles.badge, styles['badge--uq']]}>UQ</span>
            )}
          </span>
