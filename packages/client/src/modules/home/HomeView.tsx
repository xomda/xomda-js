...
import { MenuButton, PanelDivider, PluginIcon, usePanelResize, Version } from '@xomda/ui'
        ...
        <div class={styles.body}>
          ...
          {editing.value && (
            <>
              ...
              <div
                id="edit-project-meta-panel"
                class={styles.editPanelHost}
                style={{ width: `${editPanelWidth.value}px` }}
              >
