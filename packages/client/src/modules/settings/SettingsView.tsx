...
import { PanelDivider, useLocalStorageStore, usePanelResize } from '@xomda/ui'
          ...
          >
            ...
            >
              <div class="px-4 pb-2 flex-grow-1">
                ...
                <section {...sectionAttrs('appearance')}>
                  <VCard elevation={1} rounded="lg" class="mb-4">
                    {{
                      title: () => 'Appearance',
                      append: () => <SettingsScopeIndicator scope="local" />,
                      default: () => (
                        <>
                          <VDivider />
                          <VCardText class="d-flex flex-column ga-4">
                            <div>
                              <div class="text-caption text-medium-emphasis mb-1">
                                Panel transparency: {Math.round(prefs.cardSurfaceAlpha * 100)}%
                              </div>
                              <VSlider
                                modelValue={prefs.cardSurfaceAlpha}
                                onUpdate:modelValue={(v: number) => (prefs.cardSurfaceAlpha = v)}
                                min={0}
                                max={1}
                                step={0.01}
                                density="comfortable"
                              ...
                              <div class="text-caption text-disabled mt-1">
                                How opaque cards and tab panels are. Lower values let the background
                                colors and animation show through.
                              </div>
                            </div>
                            <div>
                              <div class="text-caption text-medium-emphasis mb-1">
                                Panel blur: {Math.round(prefs.cardSurfaceBlur)}px
                              </div>
                              <VSlider
                                modelValue={prefs.cardSurfaceBlur}
                                onUpdate:modelValue={(v: number) => (prefs.cardSurfaceBlur = v)}
                                min={0}
                                max={40}
                                step={1}
                                density="comfortable"
                                color="primary"
                                hideDetails
                                aria-label="Panel blur radius"
                              />
                              <div class="text-caption text-disabled mt-1">
                                Backdrop blur applied behind translucent panels. 0 turns it off
                                entirely.
                              </div>
                            </div>
                          </VCardText>
                ...
                <section {...sectionAttrs('sandbox')}>
                  <VCard elevation={1} rounded="lg" class="mb-4">
                    {{
                      ...
                      append: () => <SettingsScopeIndicator scope="project" />,
                      default: () => (
                        <>
                          <VDivider />
                          <VCardText>
                      ...
                      default: () => (
                        <>
                          ...
                          <VCardText class="d-flex flex-column ga-4">
                            ...
                            />
                            <VSwitch
                              modelValue={prefs.diagramLockPanOnSelection}
                              onUpdate:modelValue={(v: boolean | null) =>
                                (prefs.diagramLockPanOnSelection = v ?? false)
                              }
                              label="Lock pan when something is selected"
                              hint="Suppress wheel-pan on the canvas while a selection is active, so scrolling the side panel doesn't pull the canvas with it."
                              persistentHint
                              color="primary"
                              density="comfortable"
                            />
                            ...
                            <div>
                              ...
                              />
                              <div class="text-caption text-disabled mt-1">
                                How far the canvas keeps gliding after you release a drag. Slide to
                                0 to stop instantly.
                              </div>
                            </div>
                          </VCardText>
