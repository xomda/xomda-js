      ...
      return (
        <div class={styles.root}>
          <VTabs
            ...
            color="primary"
            sliderColor="primary"
            // VTabs renders an opaque .v-tabs__bar surface by default; passing
            // bgColor="transparent" lets the parent contribution VCard's frosted
            // glass show through so the tab strip matches the body.
            bgColor="transparent"
            class={styles.tabs}
          >
            {contributions.map((c) => {
