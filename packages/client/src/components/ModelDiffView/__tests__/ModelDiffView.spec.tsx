...
describe('ModelDiffView', () => {
  ...
  it('renders modified attributes with their changes list', () => {
    ...
    diff.modified.attributes.push({
      id: 'a-1',
      before: { id: 'a-1', name: 'age', type: 'string', required: false, multiValue: false, primaryKey: false, unique: false },
      after: { id: 'a-1', name: 'age', type: 'number', required: true, multiValue: false, primaryKey: false, unique: false },
