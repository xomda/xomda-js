        ...
        <div class="pa-2">
          <Section title="Added" count={countAdded(d)}>
            {d.added.packages.map((p) => (
              <VListItem key={`p-${p.id}`} title={p.name} subtitle="package">
                {{ append: () => <VChip size="x-small" color="success">+ pkg</VChip> }}
              </VListItem>
            ))}
            {d.added.entities.map((e) => (
              ...
              >
                {{ append: () => <VChip size="x-small" color="success">+ entity</VChip> }}
              </VListItem>
            ))}
            {d.added.enums.map((e) => (
              <VListItem
              ...
              >
                {{ append: () => <VChip size="x-small" color="success">+ enum</VChip> }}
              </VListItem>
            ))}
            {d.added.attributes.map((a) => (
              ...
              >
                {{ append: () => <VChip size="x-small" color="success">+ attr</VChip> }}
              </VListItem>
            ))}
            {d.added.enumValues.map((v) => (
              <VListItem
                ...
                subtitle="enum value"
              >
                {{ append: () => <VChip size="x-small" color="success">+ value</VChip> }}
              </VListItem>
            ))}
          </Section>
          ...
          <Section title="Removed" count={countRemoved(d)}>
            {d.removed.packages.map((p) => (
              <VListItem key={`p-${p.id}`} title={p.name} subtitle="package">
                {{ append: () => <VChip size="x-small" color="error">− pkg</VChip> }}
              </VListItem>
            ))}
            {d.removed.entities.map((e) => (
              ...
              >
                {{ append: () => <VChip size="x-small" color="error">− entity</VChip> }}
              </VListItem>
            ))}
            {d.removed.enums.map((e) => (
              ...
              >
                {{ append: () => <VChip size="x-small" color="error">− enum</VChip> }}
              </VListItem>
            ))}
            {d.removed.attributes.map((a) => (
              <VListItem
                ...
                subtitle={`attribute (${a.attribute.type})`}
              >
                {{ append: () => <VChip size="x-small" color="error">− attr</VChip> }}
              </VListItem>
            ))}
            {d.removed.enumValues.map((v) => (
              <VListItem
                ...
                subtitle="enum value"
              >
                {{ append: () => <VChip size="x-small" color="error">− value</VChip> }}
              </VListItem>
            ))}
          </Section>
          ...
          <Section title="Renamed" count={countRenamed(d)}>
            {d.renamed.packages.map((p) => (
              <VListItem key={`p-${p.id}`} title={`${p.oldName} → ${p.newName}`} subtitle="package" />
            ))}
