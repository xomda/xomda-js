import { useAsyncState, useVersion, Version } from '@xomda/ui'
...
import styles from './CommitModal.module.scss'
...
export const CommitModal = defineComponent({
  ...
  emits: {
    ...
    committed: (_versionId: string) => true,
  },
  setup(props, { emit }) {
      ...
      >
        <VCard>
          ...
          <VCardText>
            ...
            <p class="text-body-2 mt-2 mb-6 d-flex align-center ga-2">
              <span>Version to publish:</span>
              <Version version={props.currentVersion} prefix="v" chip size="small" />
            </p>
            <VTextField
              ...
              class={['mb-3', styles.upcomingField]}
            />
            <VTextarea
