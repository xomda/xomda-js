  ...
  setup() {
    ...
    return () => (
      <div class="d-flex flex-column fill-height">
          ...
          {{
            ...
            actions: () => (
              <>
                ...
                <VBtn prepend-icon={AddIcon} variant="tonal" color="primary" onClick={addTemplate}>
                  New template
                </VBtn>
              </>
            ),
        ...
        <div class={['d-flex', 'flex-grow-1', 'pb-2', 'pr-2']} style="min-height: 0; gap: 0">
          <VCard
            ...
            <>
              ...
              >
                ...
                <div class={styles.sidebarContent}>
                  ...
                  />
                  <VSwitch
                    modelValue={selectedTemplate.value.disabled ?? false}
                    label="Disabled"
                    ...
                    onUpdate:modelValue={(v: boolean | null) => {
                      if (!selectedTemplate.value) return
                      selectedTemplate.value.disabled = v ? true : undefined
                    }}
                  />
                </div>
                <div class={styles.sidebarFooter}>
                  <VBtn variant="text" disabled={saving.value} onClick={closeSelectedTemplate}>
                    Cancel
                  </VBtn>
                  <VBtn
                    variant="tonal"
