      ...
      return (
        ...
        >
          {{
            ...
            append: () => {
              // Folders → project-kind icons; files → plugin icons. Both
              // come from the parent via the unified `icons` prop, so flat
              // and tree views always agree on what to show.
              const appendIcons = props.entry.isDirectory
