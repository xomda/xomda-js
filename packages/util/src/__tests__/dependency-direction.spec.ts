...
const ALLOWED: Record<string, ReadonlySet<string>> = {
  ...
  xomda: new Set([
    // The bundle — workspace name matches the published name. Pulls every
    // workspace package into the published tarball.
    '@xomda/analysis-core',
    '@xomda/analysis-plugins',
    '@xomda/analysis-plugins-client',
    '@xomda/cli',
  ...
  'unplugin-xomda': new Set(['@xomda/cli', '@xomda/core', '@xomda/template', '@xomda/util']),
