...
// `createXomdaUi` pulls in `global.scss` (frosted-card aesthetic, cell
// drag-and-drop affordances, font overrides, …) as a side-effect import,
// so Storybook stories render with the same chrome the client ships.
import { createXomdaUi } from '../src'

const vuetify = createXomdaUi()
