import type { ParsedVersion, VersionPart } from '@xomda/core'
import {
  bumpVersion,
  compareVersions,
  isValidVersion,
 ...
 * Re-exports the pure helpers from `@xomda/core` so callers inside the UI
 * layer have a single, conventional `use*` entry point.
 */
