...
export const FileEntryListItem = defineComponent({
  ...
  props: {
    ...
    /** SVG path that replaces the default file/folder glyph (see FileEntryIcon). */
    primaryIcon: { type: String as PropType<string | null>, default: null },
    primaryColor: { type: String as PropType<string | null>, default: null },
  ...
  setup(props, { slots, attrs }) {
    return () => {
      ...
      return (
        <VListItem
          {...attrs}
          class={[(attrs as { class?: unknown }).class, styles.item]}
