...
describe('diff providerSource iteration', () => {
    ...
    const template = makeTemplate([
      {
        ...
        type: 'provider',
        content: '',
        providerSource: 'diff-added-entities',
        variableName: 'item',
      },
      {
        uuid: crypto.randomUUID(),
  ...
  it('emits zero files when diff is undefined and providerSource is a diff source', async () => {
    const template = makeTemplate([
      {
        uuid: crypto.randomUUID(),
        type: 'provider',
        content: '',
        providerSource: 'diff-modified-attributes',
        variableName: 'item',
      },
      {
        uuid: crypto.randomUUID(),
