...
describe('executeTemplate', () => {
  ...
  it('logic cell variable is available to subsequent output cell', async () => {
    const template = makeTemplate([
      { uuid: crypto.randomUUID(), type: 'logic', content: 'return "hello"', variableName: 'msg' },
      {
        uuid: crypto.randomUUID(),
        type: 'output',
        content: '',
  ...
  it('evaluates outputFilename using Handlebars interpolation', async () => {
    const template = makeTemplate([
      { uuid: crypto.randomUUID(), type: 'logic', content: 'return "Entity"', variableName: 'name' },
      {
        uuid: crypto.randomUUID(),
        type: 'output',
        content: '',
  ...
  it('combines outputFilename and outputDirectory into outputPath', async () => {
    const template = makeTemplate([
      {
        uuid: crypto.randomUUID(),
        type: 'output',
      ...
      const template = makeTemplate([
        {
          uuid: crypto.randomUUID(),
          type: 'logic',
          content: 'return typeof globalThis',
          variableName: 'result',
        },
        {
          uuid: crypto.randomUUID(),
