...
describe('loop cell hierarchy', () => {
  it('writes one file per iteration when the output is a child of the loop', async () => {
    ...
    const files = await renderTemplate(template, modelWith([{ name: 'A' }, { name: 'B' }]))
        ...
        packages: [
          {
            ...
            packages: [],
            enums: [],
            entities: [{ id: 'e-a-1', name: 'A1', attributes: [], kind: 'default' }],
          },
        ],
      }
      const modelB: Model = {
        ...
        packages: [
          {
            ...
            enums: [],
            entities: [
              { id: 'e-b-1', name: 'B1', attributes: [], kind: 'default', implements: [] },
              { id: 'e-b-2', name: 'B2', attributes: [], kind: 'default', implements: [] },
            ],
          },
        ],
      }
        ...
        packages: [
          {
            ...
            enums: [],
            entities: [
              { id: 'e-a', name: 'OuterEntity', attributes: [], kind: 'default', implements: [] },
            ],
          },
        ],
      }
        ...
        packages: [
          {
            ...
            enums: [],
            entities: [
              { id: 'e-b', name: 'InnerEntity', attributes: [], kind: 'default', implements: [] },
            ],
          },
        ],
      }
