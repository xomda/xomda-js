...
// Side-effect registers the npm-registry fetcher (Track F). Lives in a
// sibling module to keep `index.ts` focused on the detection plugin
// shape; importing the plugin pulls in the fetcher automatically.
import './npm-fetcher'
