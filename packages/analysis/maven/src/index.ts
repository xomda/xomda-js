  ...
  fileTypes: [
    {
      ...
      icon: 'maven',
      // Info first so the structured Dependencies / Plugins / Modules view
      // is the default tab — landing on raw XML is rarely what the user
      // wants. They can still flip to 'Source' for the underlying file.
      views: [
        {
          id: 'info',
          label: 'Info',
