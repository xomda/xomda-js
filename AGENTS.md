...
models visually and generate code from Handlebars templates. The app is self-describing — it manages its own model
...
@xomda/template   → Handlebars engine, helpers, template file storage
