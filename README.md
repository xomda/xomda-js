...
Open [http://localhost:5173](http://localhost:5173). You will see xomda's own meta-model — xomda is built on xomda,
and the `.xomda/` folder in this repo contains the model that drives the platform itself.
